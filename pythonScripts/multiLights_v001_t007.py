...
def createUI():
    ...
    myWindow=cmds.window(win,title="VRay Multiple Light v1.0",resizeToFitChildren=False,sizeable=True,maximizeButton=False,minimizeButton=True)    
    ...
    cmds.radioButtonGrp(label="Color Mode",numberOfRadioButtons=2, labelArray2=["color","temperature"], changeCommand1="setColorMode(False)",changeCommand2="setColorMode(True)",select=1,adjustableColumn=True,columnAlign=(1,"left"))
    
    cmds.separator( height=15, style='in')
    
    colorField=cmds.colorSliderGrp(label="Color",hsv=(360,0,0.700),changeCommand=setColor,dragCommand=setColor,adjustableColumn=True,columnAlign=(1,"left"))
    
    temperatureField=cmds.floatSliderGrp(label="Temperature",field=True, minValue=0, maxValue=10000, fieldMinValue=0, fieldMaxValue=30000,dragCommand=setTemperature,changeCommand=setTemperature,value=6500, precision=3, enable=False,adjustableColumn=True,columnAlign=(1,"left"))
        
    intensityField=cmds.floatSliderGrp(label="Intensity",field=True, minValue=0, maxValue=100, fieldMinValue=0, fieldMaxValue=1000000000,dragCommand=setIntensity,changeCommand=setIntensity,value=30, precision=3,adjustableColumn=True,columnAlign=(1,"left"))
    
    subdivsField=cmds.intSliderGrp(label="Subdivs",field=True, minValue=1, maxValue=32, fieldMinValue=1, fieldMaxValue=1000000000,dragCommand=setSubdivs,changeCommand=setSubdivs,value=8,adjustableColumn=True,columnAlign=(1,"left"))
    ...
    cmds.scrollLayout(height=200,width=442,childResizable=True)    
    cmds.columnLayout(adjustableColumn=True,rowSpacing=2,columnAttach=("both",8))
    
    cmds.frameLayout( label='VRayLightSphere',backgroundColor=(0.341,0.341,0.341), collapsable=True)
    cmds.columnLayout(adjustableColumn=True,rowSpacing=2,columnAttach=("both",8))
    
    radiusField=cmds.floatSliderGrp(label="Radius",field=True, minValue=0, maxValue=10, fieldMinValue=0, fieldMaxValue=1000000000,value=1, precision=3,dragCommand=setRadius,changeCommand=setRadius,adjustableColumn=True,columnAlign=(1,"left"))
    sphereSegmentsField=cmds.intSliderGrp(label="Sphere Segments",field=True, minValue=3, maxValue=64, fieldMinValue=1, fieldMaxValue=1000000000,value=20,dragCommand=setSphereSegments,changeCommand=setSphereSegments,adjustableColumn=True,columnAlign=(1,"left"))
    ...
    rayDistanceField=cmds.floatSliderGrp(label="Ray Distance",field=True,enable=False, minValue=0, maxValue=100000, fieldMinValue=0, fieldMaxValue=1000000000,value=100000,dragCommand=setRayDistance,changeCommand=setRayDistance,precision=3,adjustableColumn=True,columnAlign=(1,"left"))
