...
def createUI():
    ...
    cmds.frameLayout( label='Common Attributes',  bgc=(0.196,0.029,0),borderStyle='in', collapsable=True)
    ...
    colorField=cmds.colorSliderGrp(label="Color",changeCommand=setColor,dragCommand=setColor,adjustableColumn=True,columnAlign=(1,"left"))
    ...
    cmds.frameLayout( label='Individual Attributes',  backgroundColor=(0.196,0.029,0), collapsable=True)
    cmds.columnLayout(adjustableColumn=True,rowSpacing=2,columnAttach=("both",8))
